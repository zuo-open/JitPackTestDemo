...
public class NetModel {
    ...
    public static void showWifiDlg(final Context context) {
        ...
        if (mWifiDialog == null) {
            mWifiDialog = builder.setIcon(cc.shinichi.library.R.drawable.icon_download_new)         //
                    .setTitle("wifi设置")            //
    ...
    public static void showNoNetWorkDlg(final Context context) {
        ...
        if (mAlertDialog == null) {
            mAlertDialog = builder.setIcon(cc.shinichi.library.R.drawable.icon_download_new)         //
                    .setTitle("网络设置")            //
                    .setMessage("当前无网络").setPositiveButton("设置", new DialogInterface
                            .OnClickListener() {
